        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400">Subscribe to get latest updates</p>
              <form className="flex flex-col space-y-3">
                <input 
                  type="email" 
                  placeholder="Your email address" 
                  className="px-4 py-2 rounded-md bg-gray-800 border border-gray-700 focus:border-red-400 focus:ring-1 focus:ring-red-400 outline-none"
                />
                <button 
                  type="submit"
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              ...
              <span className="block sm:inline mt-2 sm:mt-0">Developed with ❤️ by Tayyab Ali</span>
            </p>
          </div>
        </div>
      </footer>
