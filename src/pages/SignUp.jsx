        ...
        <div className="flex items-center justify-center p-8 bg-gray-800">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold bg-gradient-to-r from-red-500 to-red-400 bg-clip-text text-transparent">
                Create Account
              </h2>
              <p className="mt-4 text-gray-400 text-lg">
                Start your cinematic journey with CineBook
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-gray-300 mb-3 text-base font-medium">Username</label>
                <div className="relative">
                  <input
                    type="text"
                    className="w-full px-5 py-4 text-lg bg-gray-700 border border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all text-white placeholder-gray-400"
                    placeholder="Enter your username"
                    onChange={(e) => setFormData({...formData, username: e.target.value})}
                    required
                  />
                  <svg className="absolute right-4 top-4 h-6 w-6 text-gray-400" 
              ...
              <div>
                <label className="block text-gray-300 mb-3 text-base font-medium">Email</label>
                <div className="relative">
                  <input
                    type="email"
                    className="w-full px-5 py-4 text-lg bg-gray-700 border border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all text-white placeholder-gray-400"
              ...
              <div>
                <label className="block text-gray-300 mb-3 text-base font-medium">Password</label>
                <div className="relative">
                  <input
                    type="password"
                    className="w-full px-5 py-4 text-lg bg-gray-700 border border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all text-white placeholder-gray-400"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-red-600 to-red-500 text-white py-4 rounded-xl font-semibold text-xl hover:from-red-500 hover:to-red-400 transition-all transform hover:scale-[1.02] shadow-xl hover:shadow-red-500/30"
              >
                Create Account
              </button>
